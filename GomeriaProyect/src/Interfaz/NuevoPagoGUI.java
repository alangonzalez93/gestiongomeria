 ...
 * @author alan
 */
public class NuevoPagoGUI extends javax.swing.JDialog {

    /**
     * Creates new form NuevoPago
     */
    public NuevoPagoGUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevoPagoGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NuevoPagoGUI dialog = new NuevoPagoGUI(new javax.swing.JFrame(), true);
